...
namespace VRUtil
{
	...
	public class VRIMGUIUtil
	{
		...
		public static Texture2D CreateColorInvertedTexture(Texture tex, bool isLiner = false)
		{
			...
			RenderTextureReadWrite renderTextureReadWrite = (RenderTextureReadWrite)1;
			if (!isLiner)
			{
				renderTextureReadWrite = (RenderTextureReadWrite)2;
			}
			...
			Texture2D texture2D = new Texture2D(renderTexture.width, renderTexture.height, (TextureFormat)5, isLiner);
